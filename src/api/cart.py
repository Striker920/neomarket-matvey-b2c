...
# ✅ ИСПРАВЛЕНО: возвращает CartResponse вместо сырого dict
...
def add_to_cart(
    ...
    ✅ ИСПРАВЛЕНО: возвращает CartResponse (по b2c/openapi.yaml:440-444)
    """
    service = CartService(db)
...
def update_cart_item(
    ...
    ✅ ИСПРАВЛЕНО: возвращает CartResponse (по b2c/openapi.yaml:461-484)
    """
    service = CartService(db)
